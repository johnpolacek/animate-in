...
export function Source() {
  return (
    <FadeIn delay={5000} className="flex flex-col gap-4 pb-8 px-4 w-full max-w-4xl opacity-80">
      ...
      <p>Read more about how it works in <a className="underline text-blue-600 font-medium" href="https://johnpolacek.medium.com/introducing-animatein-a-new-react-utility-component-for-animations-with-tailwind-and-css-2e225df156fb">this article</a>.</p>
